...
export function renderOnboarding(state, onComplete) {
  ...
  function render() {
    screen.innerHTML = step === 0 ? buildWelcome() : buildPairScreen(pairIndex);
    attachListeners();
  ...
  function buildWelcome() {
    return `
      <div class="ob-content">
        ...
        <p class="ob-sub">Ten quick choices to get started. The curriculum adapts from there.</p>
        <p style="font-family:var(--font-ui);font-size:0.85rem;font-weight:300;
                  color:var(--text-3);line-height:1.7;margin-top:4px;">
          Neither option is a commitment. Choosing one simply helps rank what you're most drawn to right now.
        </p>
      </div>
      <div class="ob-footer">
  ...
  function buildPairScreen(idx) {
    ...
    return `
      <div class="ob-content" style="display:flex;flex-direction:column;min-height:100%;">
        ...
        <button class="ob-skip" id="ob-skip"
